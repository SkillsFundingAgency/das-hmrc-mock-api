...
{
    [Test, MoqAutoData]
    public async Task GetAuthorize_ShouldReturnBadRequest_WhenNoMatchingClient(
    ...
    [Test, MoqAutoData]
    public async Task GetAuthorize_ShouldReturnBadRequest_WhenNoMatchingScope(
        [Frozen] Mock<IClientService> clientService,
        [Frozen] Mock<IScopeService> scopeService,
        [Greedy] OAuthController controller)
    {
    ...
    [Test, MoqAutoData]
    public async Task GetAuthorize_ShouldCreateAuthRequest_WhenMatchingScopeAndClient(
        [Frozen] Mock<IClientService> clientService,
        [Frozen] Mock<IScopeService> scopeService,
